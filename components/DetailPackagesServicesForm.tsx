...
export function DetailPackagesServicesForm() {
    ...
    const filteredItems = (activeTab === "packages" ? packages.data : services.data)?.filter((item: { name: string; pricingMethod: string }) => {
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {filteredItems?.map((item: SetStateAction<null>) => (
